...
internal class Feature2DetailsInteractorImpl @Inject constructor(
    private val internalInteractor: InternalInteractor,
    private val feature1ListInteractor: Feature1ListInteractor,
    ...
    init {
        Timber.i("Initializing '${Feature2DetailsInteractorImpl::class.simpleName}'")
    }
